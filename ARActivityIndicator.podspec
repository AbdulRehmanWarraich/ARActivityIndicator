...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ARActivityIndicator.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ar.warraich@outlook.com/ARActivityIndicator'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ar.warraich@outlook.com' => 'abdul.rehman@evampsaanga.com' }
  s.source           = { :git => 'https://github.com/ar.warraich@outlook.com/ARActivityIndicator.git', :tag => s.version.to_s }
